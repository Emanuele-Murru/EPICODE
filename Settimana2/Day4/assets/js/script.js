...
for (a = 0; a < starWarsCharacters.length; a++) {
  if (starWarsCharacters[a].gender === 'female') {
    femaleCharacters.push(starWarsCharacters[a])
  }
}
...
while (e < starWarsCharacters.length) {
  totalMass += parseInt(starWarsCharacters[e].mass)
  e++
}
